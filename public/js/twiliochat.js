var twiliochat = (function() {
	...
	//set total message limit in channel
	...
	$(document).ready(function() {
		...
		//create new channel with Enter Key
	...
	//leave from current public group channel
	...
	//after create new channel, hide "add new channel"  input box
